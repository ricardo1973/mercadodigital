			...
			for(let i = 0; i < galleryMix_1.length; i++){
				...
				if(offer[0] == "Disccount"){
					...
					$(offer_1[i]).html(
						...
						`<span>Ahorro <br> $${(price * offer[1]/100).toFixed(2) }</span>`
						
					)

					$(offer_2[i]).html(`$${(price-(price * offer[1]/100)).toFixed(2)}`)	
					//cuanto me voy a ahorrar (save = ahorrar). toFixed dos decimales
				...
				/*=============================================
				Agregamos la fecha al descontador .attr (atributo data-time) viene de array
				=============================================*/	
				...
				/*=============================================
				Imprimimos el total de las calificaciones para cada producto - divide y saca el promedio - Math.round rendondea decimal
				=============================================*/	
